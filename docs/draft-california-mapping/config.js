...
let descriptionDiv =
  ...
  '<p style="max-width:600px; margin-left:auto; margin-right:auto">Emails poured in throughout the summer as opposition coalesced against a bid by one of the country’s largest power producers, NRG Energy, to build a new gas plant in the town.</p>' +
  '<p style="max-width:600px; margin-left:auto; margin-right:auto">For residents of Oxnard, a city in Southern California that was already home to multiple power stations, the new plant seemed to pose too great a health risk. They decided to use every tool at their disposal to keep it from opening: locals testified at a CEC hearing; the mayor instituted a lawsuit against NRG Energy; and a group of youths even penned a <a href="https://www.facebook.com/watch/?v=1841674109183950">rap</a> in solidarity.</p>' +
...
let divChapter4 =
  ...
  '<div style="margin-left:200px; margin-right:200px;"><img src="images/GasPlantUnitBuilds.svg"></div>' +
  "<p style='max-width:600px; margin-left:auto; margin-right:auto; font-size:18px' class='bigFeature'>Now, since California’s blackouts in August 2020, experts are divided on whether history might be repeating itself. Some believe that the failure of Oxnard's plant shows that a new series of plants is unlikely today. But others point out that incumbent Governor Gavin Newsom, facing the threat of recall, has been handing out gas plant licenses and attempting to reboot old plants.</p>" +
