...
let divChapter5 =
  ...
  "<embed type='text/html' src='images/GasPlantSchoolSmallMultiples_1280_V3.html' width='1280px'></embed>"
  '<div style="display:flex; justify-content:center; align-items:center;"><img style="max-width:2000px; min-width:200px;" src="images/GasPlantSchoolSmallMultiples1.svg"></div>' +
